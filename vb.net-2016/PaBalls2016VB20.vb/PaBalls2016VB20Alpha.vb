...
Class PaBalls2016VB20Alpha : Inherits Form
	Private rm As New ResourceManager("PaBalls2016VB20Alpha", _
	...
	Sub New()
		...
		timer1 = New System.Threading.Timer(AddressOf PaBalls2016VB20Alpha_Timer, _
	...
	Sub PaBalls2016VB20Alpha_Resize(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Resize
		PA_DoBallsInit()
	End Sub

	Sub PaBalls2016VB20Alpha_Timer(ByVal sender As Object)
		If nPathID=0 Then
			PA_DoBallsMove()
		Else
	...
	Sub PaBalls2016VB20Alpha_Paint(ByVal sender As Object, ByVal e As PaintEventArgs) Handles Me.Paint
		...
		For i=0 To nCount - 1
			...
			g.DrawImage(A_imgBalls(A_objBalls(i).nIconID), New Rectangle(A_objBalls(i).x, _
				A_objBalls(i).y + nStartY, nBallDiameter, nBallDiameter), _
	...
	Shared Sub Main()
		Application.Run(New PaBalls2016VB20Alpha())
	End Sub
End Class
